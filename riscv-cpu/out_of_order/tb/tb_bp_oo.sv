...
// tb_bp_oo -- branch predictor benchmark harness, out-of-order core
...
module tb_bp_oo;
    ...
    localparam int MAX_CYC = 200000;    // commit-bound, so far slower than in-order
    ...
    task automatic run_scn(input int n);
        ...
        got = u_core.u_rf.regs[bp_scn[n].chk_reg];
    ...
    initial begin
        $display("\n=== out-of-order core, BP_MODE=%s, %0d entries, %0d GHR bits, %0d-bit counters ===",
